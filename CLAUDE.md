...
- [ ] Plan 8: progress — followed plan, check-ins, starting points, restart, cleared debts, celebration
...
- Home uses `homePlanProvider`: the cheapest pay-off method on Current settings (`currentPlansProvider`), ignoring saved scenarios and the slider.
