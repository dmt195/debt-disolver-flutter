...
void main() {
  ...
  test(
    'S1: one interest-free card, 1000.00 at 250.00 a month',
    () => nominal(() {
  ...
  test(
    'S2: one 12% card, 1200.00, min 25.00 or 2%, at 100.00 a month',
    () => nominal(() {
      final p = runAll([
        debt(
          id: 'card',
  ...
  test(
    'S3: two cards and a fixed-payment loan at 450.00 a month',
    () => nominal(() {
      final p = runAll([
        debt(
          id: 'c1',
  ...
  test(
    'S4: APRs 0.5% apart are ordered correctly (legacy comparator bug)',
    () => nominal(() {
      final p = runAll([
        debt(
          id: 'x',
